...
def create_checkout_session(request):
    ...
    try:
        ...
        session = stripe.checkout.Session.create(
            ...
            mode="subscription",
            success_url=f"https://lamprey-included-lion.ngrok-free.app/api/payment/success/",
            cancel_url=f"https://lamprey-included-lion.ngrok-free.app/api/payment/cancel",
